...
{
$uname=$_COOKIE["usertype"];
if($uname == "analyst"){echo "<script language=javascript> window.location = 'analyst.php';</script>";}
 elseif ($uname  == "therapist") {echo "<script language=javascript>window.location = 'therapist.php';</script>";}
 elseif ($uname  == "subject") {echo "<script language=javascript>window.location = 'subject.php';</script>";}
 elseif ($uname == "collector") {echo "<script language=javascript>window.location = 'collector.php';</script>";}
 elseif ($uname == "admin") {echo "<script language=javascript>window.location = 'admin.php';</script>";} 
...
<body onload="document.form1.username.focus();" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
...
<td valign="top">
<p>This is a demo website created for DBMS Spring 2011 Project. To login into the website, please read the Project report and watch navigation video in the Documents section. </p>
